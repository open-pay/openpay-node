...
function Openpay(merchantId, privateKey, isProductionReady, countryCode = 'mx') {
...
function Customers(baseData) {
    ...
    this.checkouts = {
        ...
        get: function (customerId, checkoutId, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: this.baseUrl + customerId + '/checkouts/' + checkoutId,
                requestData: {method: 'GET'},
                callback: callback
            }));
        }
